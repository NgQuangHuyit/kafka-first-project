...
public class PosFanoutApp {
    final static Logger logger = LoggerFactory.getLogger(PosFanoutApp.class);
    ...
    public static void main(String[] args) {
        ...
        kStream00.filter((k, v) -> v.getCustomerType().equalsIgnoreCase(AppConfigs.CUSTOMER_TYPE_PRIME))
