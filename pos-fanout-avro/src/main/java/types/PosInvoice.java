...
public class PosInvoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: CustomerCardNo = (java.lang.CharSequence)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoice>
    ...
    /**
      ...
      * @return This builder.
      */
    public types.PosInvoice.Builder setCustomerCardNo(java.lang.CharSequence value) {
    ...
    public PosInvoice build() {
      try {
        ...
        record.CustomerCardNo = fieldSetFlags()[2] ? this.CustomerCardNo : (java.lang.CharSequence) defaultValue(fields()[2]);
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (types.LineItem e0: this.InvoiceLineItems) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.DeliveryAddress == null) {
          this.DeliveryAddress = new types.DeliveryAddress();
        }
        this.DeliveryAddress.customDecode(in);
      }

      long size0 = in.readArrayStart();
      java.util.List<types.LineItem> a0 = this.InvoiceLineItems;
      if (a0 == null) {
        a0 = new SpecificData.Array<types.LineItem>((int)size0, SCHEMA$.getField("InvoiceLineItems").schema());
        this.InvoiceLineItems = a0;
      } else a0.clear();
      SpecificData.Array<types.LineItem> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<types.LineItem>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          types.LineItem e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new types.LineItem();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
